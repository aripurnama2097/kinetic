...
<?php
  ...
  foreach ($param as $key => $value) {
      ...
      echo '<td width="110px">: ' . substr($value->jknpo, 0, 15) . '</td>';
 ...
 $barcode = $value->partno . ':' . $value->partname . ':' . $value->qty_input . ':' . $value->dest . ':' . $value->jknpo . ':' . $value->shelfno . ':' . $value->idnumber;
          ...
          $data .= $esc . 'H0150' . $esc . 'V0085' . $esc . 'L0101' . $esc . 'M' . 'CustPO: ' . substr($value->jknpo, 0, 15);
