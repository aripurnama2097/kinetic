...
@section('section')
    <div class="page-wrapper">
        ...
        <!-- Page body MENU -->
        <div class="page-body  bg-dark">
            <div class="container-xl mt-1   ">
                <div class="row row-deck row-cards ">
                    <div class="col-12 ">
                        {{-- <div class="card rounded-1 col-12"> --}}
                            {{-- <div class="card-header text-center justify-content-center mb-2">
                                <h2 style="font-size:30px">--RELEASE SCHEDULE--</h2>
                            </div> --}}
                            ...
                            {{-- <div class="card col-12">
                                <div class=" col-sm-12 col-lg-12">
                                    ...
                                    <form id="filter-Data" class="btn-group">
                                        <input type="date" class="form-control rounded-3 form-control-sm col-6"
                                            name="start_date" id="release-date" value="{{ date('Y-m-d') }}">
                                        <input type="date" class="form-control rounded-3 form-control-sm col-6"
                                            name="end_date" id="release-date" value="{{ date('Y-m-d') }}">
