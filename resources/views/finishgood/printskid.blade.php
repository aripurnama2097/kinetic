  ...
  <div class="col-12">
    ...
    <div class="d-flex justify-content-center">
      <div class="table" widht="100%">
          ...
          <table class="border border-dark border-2 col-12 mt-2">
            <tbody>
              <tr >
                <td  class="border border-dark border-2 col-12" align="center" colspan="4" style="font-weight:bold;">PT JVCKenwood Electronics Indonesia</td>
              </tr>
              <tr>
                <td  rowspan="6" width="70px" align="center" style="font-weight:bold;font-size: 30px;vertical-align:middle"> {!! QrCode::size(80)->generate($skid_no) !!} </td> 
                <td>SKID NO</td>
                <td>: {{ $skid_no }}</td>
                <td>SHIPMENT</td>
