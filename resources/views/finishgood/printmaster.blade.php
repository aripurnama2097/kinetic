          ...
          <table class="border border-dark border-3 col-12 mt-2">
            <thead>
              <tr>
                ...
                <th  style="border-color:black"class="text-center" > TOTAL CARTON : {{$data[0]->tot_carton }}</th>
                <th class="text-center mb-1"   style="border-color:black;">GW :  {{$data[0]->total_gw }} </th>
              </tr>
              <tr>
