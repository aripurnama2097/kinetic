...
{{-- <div class="page"> --}}
 ...
 <header class="navbar navbar-expand-md navbar-dark navbar-overlap d-print-none">
    ...
    <div class="container-fluid mt-2">
        ...
        <div class="row">
            <div class="row">
                <div class="col-2">
                    <div class="ml-3">
                        <h1  style="font-size:35px">KINETIC</h1>
                    </div>
              </div>
                ...
                <div class="ml-4 d-flex justify-content-end mt-2 bg-secondary ">
                            ...
                            <div class="d-none d-xl-block ps-2">
                                @auth
                                    <div style="font-weight:bold;font-size:15px" class="text-white float-right d-flex justify-content-end mr-3  ">
                                        <i class="ti ti-user-circle mr-1"></i> {{ auth()->user()->name }}
                                    </div>
            ...
            <div class="collapse navbar-collapse ml-2" id="navbar-menu">
    ...
    {{-- <div class="nav-item active dropdown mt-5" style="align:center">
        <a href="#" class="nav-divnk d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
        aria-label="Open user menu">
        <div class="d-none d-xl-block ps-2">
            @auth
                <div style="font-weight:bold;font-size:15px" class="text-white float-right d-flex justify-content-end mr-3  ">
 ...
 {{-- <div class="nav-item active dropdown mt-5"> 
